...
<body>
	...
	<%--
		...
		3. 형식
			1) 일반 for문
			<cLforEach var="변수" begin="시작값" end="종료값" step="증가값">
				반복실행문
			</c:forEach>
			2) 향상 for문
	 ...
	 <c:forEach var="season" items="${seasons}" varStatus="vs">
	  ...
	  <%
	  	...
	  	// 	webtoonList.add(new Webtoon(순번, "제목", 평점, 작성일(년, 월, 일)));
	  	...
	  	webtoonList.add(new Webtoon(419, "HBJY", 9.96, LocalDate.of(2022, 12, 14)));
